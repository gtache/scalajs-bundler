...
import com.github.gtache.BundlerFileType
import com.github.gtache.scalajsbundler.{BundlerFile, BundlerFileType}
import sbt.{AttributeKey, Attributed}
import scalajsbundler.{BundlerFile, BundlerFileType}

/**
  * SBT Specific Extensions to [[BundlerFile]]
  *
...
object SBTBundlerFile {
  ...
  /**
    * A [[BundlerFileType]], allowing unambigiuous selection of output files
