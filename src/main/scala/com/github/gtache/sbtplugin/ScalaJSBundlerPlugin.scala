...
object ScalaJSBundlerPlugin extends AutoPlugin {
  ...
  /**
    ...
    */
  object autoImport {
    type BundlingMode = gtache.BundlingMode
    val BundlingMode = scalajsbundler.BundlingMode
    type BundlerFile = gtache.BundlerFile
    val BundlerFile = scalajsbundler.BundlerFile
    type BundlerFileType = gtache.BundlerFileType
    ...
    /**
      ...
      * used to filter the list of files by their [[BundlerFileType]]. For example:
      *
      * {{{
